...
def serialize_trip(
    ...
    return {
        ...
        "attractions":
            trip.attractions,
        "recommended_hotels":
            trip.recommended_hotels,
        "recommended_restaurants":
            trip.recommended_restaurants,
        "local_cuisines":
            trip.local_cuisines,
        "beverages_to_try":
            trip.beverages_to_try,
        "weather_summary":
        ...
        "carbon_footprint_estimate":
            trip.carbon_footprint_estimate,
...
def create_trip(
    ...
    auth_service.increment_trip_count(
        current_user.id
    )
...
def trip_statistics(
    ...
    stats = (
        trip_service.get_trip_statistics(
            current_user.id
        )
    )
