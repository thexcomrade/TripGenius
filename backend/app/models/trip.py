...
class Trip(Base):
    ...
    trip_title: Mapped[str] = mapped_column(
        String(200),
        nullable=False
    )
    ...
    transportation_mode: Mapped[str | None] = mapped_column(
        String(100),
        nullable=True
    )
    ...
    ai_itinerary: Mapped[dict] = mapped_column(
        JSON,
        default=dict,
        nullable=False
    )

    itinerary_summary: Mapped[str | None] = mapped_column(
        Text,
        nullable=True
    )

    attractions: Mapped[list] = mapped_column(
        JSON,
        default=list,
        nullable=False
    )

    recommended_hotels: Mapped[list] = mapped_column(
        JSON,
        default=list,
        nullable=False
    )
    ...
    local_cuisines: Mapped[list] = mapped_column(
        JSON,
        default=list,
        nullable=False
    )

    beverages_to_try: Mapped[list] = mapped_column(
        JSON,
        default=list,
        nullable=False
    )
    ...
    weather_alerts: Mapped[list] = mapped_column(
        JSON,
        default=list,
        nullable=False
    )

    packing_checklist: Mapped[list] = mapped_column(
        JSON,
        default=list,
        nullable=False
    )

    travel_tips: Mapped[list] = mapped_column(
        JSON,
        default=list,
        nullable=False
    )
    ...
    food_cost: Mapped[float] = mapped_column(
        Float,
        default=0.0,
        nullable=False
    )
